...
namespace Tehtava8
{
    public partial class Form1 : Form
    {
        ...
        private void muuta_button_Click(object sender, EventArgs e)
        {
            int luku1, luku2, luku3, luku4;
                string vastaus="";
            if(numero_textBox.Text.Length > 3)
            {
                luku1 = Convert.ToInt32(numero_textBox.Text.Substring(0, 1));
                luku2 = Convert.ToInt32(numero_textBox.Text.Substring(1, 1));
                luku3 = Convert.ToInt32(numero_textBox.Text.Substring(2, 1));
                luku4 = Convert.ToInt32(numero_textBox.Text.Substring(3, 1));
                if(luku1 % 3 == 0)
                {
                    vastaus += "MMM";
                }
                ...
                vastaus_label.Text = vastaus;
                vastaus_label.Visible = true;
            }
            else if (numero_textBox.Text.Length > 2)
            {
                luku2 = Convert.ToInt32(numero_textBox.Text.Substring(0, 1));
                luku3 = Convert.ToInt32(numero_textBox.Text.Substring(1, 1));
                luku4 = Convert.ToInt32(numero_textBox.Text.Substring(2, 1));
                vastaus += sataset(luku2, vastaus);
                vastaus += kympit(luku3, vastaus);
                vastaus += ykkoset(luku4, vastaus);
                vastaus_label.Text = vastaus;
            ...
            else if (numero_textBox.Text.Length > 1)
            {
                luku3 = Convert.ToInt32(numero_textBox.Text.Substring(0, 1));
                luku4 = Convert.ToInt32(numero_textBox.Text.Substring(1, 1));
                vastaus += kympit(luku3, vastaus);
                vastaus += ykkoset(luku4, vastaus);
                vastaus_label.Text = vastaus;
                vastaus_label.Visible = true;
            ...
            {
                luku4 = Convert.ToInt32(numero_textBox.Text.Substring(0, 1));
                vastaus += ykkoset(luku4, vastaus);
                vastaus_label.Text = vastaus;
                vastaus_label.Visible = true;
            }
